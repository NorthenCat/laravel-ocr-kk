...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <x-breadcrumb>
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="{{ route('desa.show', $kk->getRw->getDesa->id) }}"
                    class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">{{
                    $kk->getRw->getDesa->nama_desa }}</a>
            </div>
        </li>
        <li>
            <div class="flex items-center">
                ...
                <a href="{{ route('rw.index', [$kk->getRw->getDesa->id, $kk->getRw->id]) }}"
                    class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2">{{ $kk->getRw->nama_rw
                    }}</a>
            </div>
        </li>
        <li>
            <div class="flex items-center">
                ...
                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">KK {{ $kk->no_kk }}</span>
            </div>
        </li>
    </x-breadcrumb>
    ...
    <div class="mb-8">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">KK {{ $kk->no_kk }}</h1>
                <p class="mt-2 text-gray-600">{{ $kk->nama_kepala_keluarga }} - {{ $kk->getRw->getDesa->nama_desa }}, {{
                    $kk->getRw->nama_rw }}</p>
            </div>
            <div class="flex space-x-3">
                <a href="{{ route('anggota.create', [$kk->getRw->getDesa->id, $kk->getRw->id, $kk->id]) }}"
                ...
                <a href="{{ route('kk.edit', [$kk->getRw->getDesa->id, $kk->getRw->id, $kk->id]) }}"
    ...
    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
        <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-600">Manage family members in this KK</p>
        </div>
        ...
        <div class="p-6">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <a href="{{ route('anggota.edit', [$kk->getRw->getDesa->id, $kk->getRw->id, $kk->id, $anggota->id]) }}"
                                        class="text-indigo-600 hover:text-indigo-900">Edit</a>
                                    <form
                                        action="{{ route('anggota.destroy', [$kk->getRw->getDesa->id, $kk->getRw->id, $kk->id, $anggota->id]) }}"
            ...
            <div class="text-center py-12">
                ...
                <h3 class="mt-2 text-sm font-medium text-gray-900">No family members found</h3>
